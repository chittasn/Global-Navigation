...
import { autobind, DialogContent, DialogFooter, PrimaryButton, Button, TextField } from '@microsoft/office-ui-fabric-react-bundle';
...
var PromptDialogReact =  (function (_super) {
    ...
    PromptDialogReact.prototype.render = function () {
        ...
        return React.createElement(DialogContent, { title: 'Prompt', subText: this.props.message },
            React.createElement(TextField, __assign({ componentRef: function (c) { return _this._textElement = c; }, onChanged: this._onValueChanged, value: this.props.defaultValue, onKeyDown: this._onKeyDown }, { autoFocus: true } )),
